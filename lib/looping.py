...
# Write a function happy_new_year() using a while loop that outputs
#  numbers starting at 10 and counting down to 1. After reaching 1, print out "Happy New Year!"
def happy_new_year():
    i = 10
    while i >= 1:
        print(i)
